...
class TestRendererModelIntegration:
    ...
    def test_renderer_connects_to_model_signals(self, canvas_renderer, canvas_model, qtbot):
    ...
    def test_renderer_updates_on_item_removed(self, canvas_renderer, canvas_model, qtbot):
    ...
    def test_renderer_updates_on_item_modified(self, canvas_renderer, canvas_model, qtbot):
    ...
    def test_renderer_updates_on_items_cleared(self, canvas_renderer, canvas_model, qtbot):
...
class TestFullIntegration:
    ...
    def test_complete_workflow_add_update_remove(self, canvas_renderer, canvas_model, qtbot):
    ...
    def test_renderer_survives_rapid_changes(self, canvas_renderer, canvas_model, qtbot):
